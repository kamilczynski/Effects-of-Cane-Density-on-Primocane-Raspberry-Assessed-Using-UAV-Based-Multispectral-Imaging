<img src="all_layers.png" alt="all_layers.png" width="800"/>
...
<p align="justify">In addition, the DataCorrectness_Test.py script is used to verify the integrity of the final merged dataset with
  ...
  <img src="VegetationIndex.png" alt="VegetationIndex.png" width="800"/>

<p align="justify">
Finally, a custom post-processing algorithm (SpectralVistula.py) was applied as the final analytical step of the workflow.
This algorithm performs a synthetic temporal and spatial analysis of vegetation index metrics derived from Pix4D Fields,
including measures of spatial heterogeneity, temporal dynamics, structural characteristics of change, and level–motion
relationships. The output of this step constitutes the final dataset used for statistical analysis and interpretation.
All parameters generated by SpectralVistula are described below.</p>
